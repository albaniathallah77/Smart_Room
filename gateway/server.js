...
Halo, aku siap bantu kontrol Smart Room. Kamu bisa ketik atau tekan voice untuk memberi perintah.</div>
            ...
            <section class="page" id="toolsPage">
              ...
              <div class="tools-grid">
                ...
                <article class="tool-card device-card" id="card-tv">
                  ...
                  <div class="control-row">
                    <button class="blue" onclick="queue({device:'tv',state:'joken'})">JOKEN</button>
        ...
        <script>
          ...
          function updateToolStatus(state = {}) {
            ...
            if (tvState) {
              const tvLabel = state.jokenMode === true ? 'JOKEN' : (state.kenzieMode === true ? 'KENZIE' : (state.kacauMode === true ? 'KACAU' : (state.stikmanMode === true ? 'STIKMAN' : (state.catMode === true ? 'CAT' : (state.fightMode === true ? 'FIGHT' : 'ON')))));
      ...
      messages: [
        {
          ...
          content: [
            ...
            '{"device":"tv","state":"on|off|fight|cat|stikman|kacau|kenzie|joken"}',
            ...
            'For fight animation, use {"device":"tv","state":"fight"}. For cat animation, use {"device":"tv","state":"cat"}. For stikman animation, use {"device":"tv","state":"stikman"}. For kacau/kicau animation, use {"device":"tv","state":"kacau"}. For kenzie OLED image, use {"device":"tv","state":"kenzie"}. For joken OLED image, use {"device":"tv","state":"joken"}.',
...
function normalizeCommand(command) {
  ...
  if (device === 'tv' || device === 'oled' || device === 'smart_tv') {
    ...
    if (state === 'joken') return { device: 'tv', state: 'joken' };
